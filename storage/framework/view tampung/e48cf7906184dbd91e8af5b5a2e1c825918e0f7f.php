...
<?php $__env->startPush('style'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/js/ol-layerswitcher/dist/ol-layerswitcher.css')); ?>" />
<?php $__env->stopPush(); ?>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($countPenyulang); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($countGI); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($countTrafo); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/ol4/proj4.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/js/ol-layerswitcher/dist/ol-layerswitcher.js')); ?>"></script>
                    ...
                    source: new ol.source.TileWMS({
                        ...
                        params: {
                            ...
                            <?php if(Auth::user()->role == 2): ?>
                                'CQL_FILTER': "kecamatan='<?php echo e(Auth::user()->region->name); ?>'",
                            <?php elseif(Auth::user()->role == 3): ?>
                                'CQL_FILTER': "kelurahan='<?php echo e(Auth::user()->region->name); ?>'",
                            <?php endif; ?>
                        },
                        ratio: 1,
                        serverType: 'geoserver'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MasterDataPLN2\resources\views/admin/Dashboard.blade.php ENDPATH**/ ?>