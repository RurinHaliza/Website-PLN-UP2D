    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if (Auth::user()->hasRole('Administrator'))
                    ...
                    <li class="{{ Request::is('MonitoringBebanUP3-new') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('data.monitoringbebanup3new') }}">
                    ...
                    <li class="{{ Request::is('admin.approval') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.approval') }}"><i class="fa fa-check-square"></i>
            ...
            <li class="{{ Request::is('scadafail') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('scadafail.operator') }}"><i class="fa fa-exclamation-triangle"></i>
                    <span>Input
                        Scada
                        Fail</span></a>
            </li>
        ...
        @elseif(Auth::user()->hasRole('ValidatorOpsis'))
            ...
            <li class="{{ Request::is('approval') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('approval.opsis') }}"><i class="fa fa-check-square"></i>
                    <span>Approval</span></a>
            </li>
            </li>
            <li class="menu-header">Tabel Asset</li>
        ...
        @elseif(Auth::user()->hasRole('ValidatorFasop'))
            ...
            <li class="{{ Request::is('approval.validfasop') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('approval.validfasop') }}"><i class="fa fa-check-square"></i>
                    <span>Approval</span></a>
            </li>
            <li class="menu-header">Tabel Asset</li>
