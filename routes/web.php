...
Route::group(['prefix' => 'EditorOpsis', 'middleware' => ['auth', 'role:EditorOpsis']], function () {
    ...
    //Trafo
    Route::get('bebantrafo', [TrafoController::class, 'index'])->name('bebantrafo.editorop');
    Route::get('DetailTrafo/{id}', [TrafoController::class, 'detail'])->name('detail.trafo.editorop');

    //Penyulang
    Route::get('bebanpenyulang', [PenyulangController::class, 'index'])->name('bebanpenyulang.editorop');
    Route::get('Detail/{id}', [PenyulangController::class, 'detail'])->name('detail.penyulang.editorop');

    Route::get('bebanup3', [MenuController::class, 'bebanup3'])->name('bebanup3');

    //KTT
    Route::get('bebanktt', [KTTController::class, 'index'])->name('bebanktt.editorop');
    Route::get('DetailKTT/{id}', [KTTController::class, 'Detail'])->name('detail.ktt.editorop');

    //GI
    Route::get('BebanGI', [GIController::class, 'index'])->name('beban.GI.editorop');
    Route::get('DetailGI/{id}', [GIController::class, 'detail'])->name('detail.gi.editorop');

    //MVCELL
    Route::get('mvcell', [MenuController::class, 'mvcell'])->name('data.mvcell.editorop');
    Route::get('mvcell/{id}', [MenuController::class, 'DetailMVCELL'])->name('detail.mvcell.editorop');
    Route::get('EditMVCELL/{id}', [MenuController::class, 'EditMVCELL'])->name('edit.mvcell.editorop');

    Route::get('DataForm', [DataForm::class, 'index'])->name('dataform.index.editorop');
    Route::get('TambahData', [DataForm::class, 'TambahData'])->name('tambahdataform.admin');
    Route::post('/dataform/store', [DataForm::class, 'store'])->name('dataform.store');
});
...
Route::group(['prefix' => 'Manager', 'middleware' => ['auth', 'role:Manager']], function () {
    ...
    Route::get('DetailGI/{id}', [GIController::class, 'detail'])->name('detail.gi.manager');
